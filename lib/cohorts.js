    ...
    constructor.prototype = {
      run: function() {
        ...
        if(in_test) {
          ...
          this.options.storageAdapter.onInitialize(in_test, this.options.name, chosen_cohort, isNew);
      ...
      event: function(eventName) {
        if(this.inTest()) {
          var cookieName = 'ev_' + eventName;
          var isNew = this.getCookie(cookieName) === null;
        
          this.options.storageAdapter.onEvent(this.options.name, this.getCohort(), eventName, isNew);
